...
Set-FTA 'PhotoViewer.FileAssoc.Tiff' '.bmp'
Set-FTA 'PhotoViewer.FileAssoc.Tiff' '.dib'
Set-FTA 'PhotoViewer.FileAssoc.Tiff' '.jpg'
Set-FTA 'PhotoViewer.FileAssoc.Tiff' '.jpe'
Set-FTA 'PhotoViewer.FileAssoc.Tiff' '.jpeg'
Set-FTA 'PhotoViewer.FileAssoc.Tiff' '.jxr'
Set-FTA 'PhotoViewer.FileAssoc.Tiff' '.jfif'
Set-FTA 'PhotoViewer.FileAssoc.Tiff' '.wdp'
Set-FTA 'PhotoViewer.FileAssoc.Tiff' '.png'
Set-FTA 'PhotoViewer.FileAssoc.Tiff' '.gif'
Set-FTA 'PhotoViewer.FileAssoc.Tiff' '.tiff'
Set-FTA 'PhotoViewer.FileAssoc.Tiff' '.tif'